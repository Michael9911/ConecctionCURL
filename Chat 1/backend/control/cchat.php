...
$conexion = $connection -> insertarMensaje("chat 1" , $mensaje);//Ejecucion del metodo insertarMensaje tomando como parametros, "chat 2"(esta maquina) y $mensaje que es la variable enviada por el usuario
