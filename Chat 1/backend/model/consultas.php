...
class consultas
{
  ...
  public function insertarMensaje($nombre,$mensaje)
  {
    ...
    if ($nombre === "chat 1")//Verifiacion de quien envio el mensaje, si el mensaje proviene de esta maquina, se enviara al otro servidor, de lo contrario, no se ejecutara otra accion
    {
      $curl = new curl();
